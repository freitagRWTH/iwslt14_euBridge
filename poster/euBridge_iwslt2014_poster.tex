...
\begin{block}{EU-BRIDGE}
   ...
   \item EU-BRIDGE IWSLT 2014 single systems:
    ...
    \item Our system combination framework is publicly available as part of the \textbf{Jane} toolkit \url{http://www.hltpr.rwth-aachen.de/jane/}
    \end{itemize}
    \vspace{-1.0ex}
    ...
    \begin{itemize}
        \item Features (weights optimized with MERT):
            \begin{itemize}
                ...
                \item Word penalty
                \item RNN language model used in an additional rescoring step
            \end{itemize}
    \end{itemize}
 \vspace{-1.1ex}
