...
\begin{block}{RWTH Aachen University}
  ...
  \begin{itemize}
    \item Phrase-based systems based on open source \emph{Jane} toolkit
...
\item SLT system:
  \vspace*{0.5ex}
  \begin{itemize}
    \item Monolingual, monotone SMT punctuation model for punctuation of ASR output 
    \item Operation sequence model over words and word clusters
    \item Sparse lexical features and hierarchical lexicalized reordering
  \end{itemize}
\vspace*{0.5ex}
\item MT systems:
  \vspace*{0.5ex}
...
\begin{table}[bt!]
  ...
  \begin{center}
    ...
    \begin{tabular}{l|c|c}
      %\hline
        \bf{\small{system}} & \multicolumn{2}{c}{\bf{\small{dev2012}}} \\
                  & \small{\BLEU} & \small{\TER} \\
       \hline
       \textbf{\small{KIT}}                               & \rdm{20.7182832044} & \rdm{60.50384083210076} \\
       \textbf{\small{RWTH}}                              & \rdm{20.7958068268} & \rdm{61.41991507228398} \\
       \textbf{\small{UEDIN}}                             & \rdm{20.289498398} & \rdm{62.95624791259125} \\ \hline
       \textbf{\small{syscom}}                            & \rdm{22.2321791584} & \rdm{59.27763729185552} \\
      \end{tabular}
     \end{center}
     \vspace{-0.75cm}
...
\small
    \begin{tabular}{l|c|c|c|c|c|c}
      %\hline
        \bf{\small{system}} & \multicolumn{2}{c|}{\bf{\small{tst2010}}} & \multicolumn{2}{c|}{\bf{\small{tst2011}}}  & \multicolumn{2}{c}{\bf{\small{tst2012}}} \\
                  & \small{\BLEU} & \small{\TER} & \small{\BLEU} & \small{\TER} & \small{\BLEU} & \small{\TER} \\
       \hline 
       \textbf{\small{KIT}}                                & \rdm{31.5055077292} & \rdm{47.606222869997783} & \rdm{37.0506652671} & \rdm{42.45201517484882} & \rdm{31.9539484287} & \rdm{47.58388819302525} \\
      \textbf{\small{RWTH}}                               & \rdm{31.8236101862} & \rdm{47.162637432274007} & \rdm{38.3003021787} & \rdm{41.321413815122265} & \rdm{31.9973577528} & \rdm{47.00046146746654}  \\
      \textbf{\small{UEDIN}}                              & \rdm{31.61} & \rdm{47.61} & \rdm{37.30} & \rdm{42.54} & \rdm{31.68} & \rdm{47.90} \\ \hline
      \textbf{\small{syscom}}                             & \rdm{33.3225473047} & \rdm{46.07585310985077} & \rdm{39.4434507166} & \rdm{40.60774518273673} & \rdm{33.4725712172} & \rdm{46.16322763530885} \\
      \end{tabular}
     \end{center}
...
\small
    \begin{tabular}{l|c|c|c|c|c|c}
      %\hline
        \bf{system} & \multicolumn{2}{c|}{\bf{\small{tst2010}}} & \multicolumn{2}{c|}{\bf{\small{tst2011}}}  & \multicolumn{2}{c}{\bf{\small{tst2012}}} \\
                  & \small{\BLEU} & \small{\TER} & \small{\BLEU} & \small{\TER} & \small{\BLEU} & \small{\TER} \\
       \hline 
       \textbf{\small{FBK}}                             & \rdm{32.7992} & \rdm{50.4449} & \rdm{39.1848} & \rdm{42.6122} & \rdm{40.0121} & \rdm{41.3801} \\
      \textbf{\small{KIT} }                              & \rdm{33.1161} & \rdm{48.3904} & \rdm{37.2869} & \rdm{42.4766} & \rdm{39.1408} & \rdm{40.2053} \\
      \textbf{\small{RWTH}}                              & \rdm{34.5252} & \rdm{47.5973} & \rdm{41.1475} & \rdm{40.1044} & \rdm{41.9988} & \rdm{38.5893} \\
      \textbf{\small{UEDIN-A} }                          & \rdm{33.62} & \rdm{48.51} & \rdm{40.23} & \rdm{40.61} & \rdm{40.99} & \rdm{39.58} \\
      \textbf{\small{UEDIN-B}}                           & \rdm{33.23} & \rdm{49.12} & \rdm{39.13} & \rdm{41.95} & \rdm{40.67} & \rdm{39.76} \\ \hline
      \textbf{\small{syscom} }                           & \rdm{35.1119} & \rdm{48.5091} & \rdm{41.6735} & \rdm{41.3786} & \rdm{43.9523} & \rdm{38.6568} \\
       \textbf{\small{ +RNN}}                            & \rdm{35.2208} & \rdm{48.5278} & \rdm{41.7089} & \rdm{41.2702} & \rdm{44.3163} & \rdm{38.5443}
      \end{tabular}
     \end{center}
    ...
    \begin{tabular}{l|c|c|c|c|c|c}
      %\hline
        \bf{system} & \multicolumn{2}{c|}{\bf{\small{tst2010}}} & \multicolumn{2}{c|}{\bf{\small{tst2011}}}  & \multicolumn{2}{c}{\bf{\small{tst2012}}} \\
                    & \small{\BLEU} & \small{\TER} & \small{\BLEU} & \small{\TER} & \small{\BLEU} & \small{\TER} \\
       \hline
       \textbf{\small{KIT} }                             &        \rdm{24.5282} & \rdm{55.1522} & \rdm{27.0848} & \rdm{50.5152} & \rdm{23.5199} & \rdm{56.0189} \\
          \textbf{\small{UEDIN-A}}                              &\rdm{24.85} & \rdm{55.47} & \rdm{27.82} & \rdm{50.05} & \rdm{23.37} & \rdm{56.90} \\
          \textbf{\small{UEDIN-B} }                             &\rdm{24.12} & \rdm{55.73} & \rdm{26.73} & \rdm{50.84} & \rdm{22.19} & \rdm{57.26} \\
      \textbf{\small{UEDIN-C} }                             &\rdm{24.75} & \rdm{55.31} & \rdm{26.45} & \rdm{50.54} & \rdm{23.11} & \rdm{56.62} \\ \hline
       \textbf{\small{syscom}}                              &\rdm{25.8934} & \rdm{54.0387} & \rdm{28.1208} & \rdm{49.0931} & \rdm{24.9475} & \rdm{55.0294} \\
      \end{tabular}
     \end{center}
