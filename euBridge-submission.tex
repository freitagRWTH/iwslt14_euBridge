...
\end{packed_itemize}
%
\noindent Model weights were optimized on a concatenation of dev2010 and dev2012.
...
Additional features of the systems are:
\begin{packed_itemize}
\item LMs over Brown clusters \\(UEDIN-A: 7-gram, UEDIN-B: 5-gram)
\end{packed_itemize}
%
\noindent Model weights were optimized on dev2010.
...
\noindent \textit{Phrase-based systems.} UEDIN-A and UEDIN-B employ factored models. Source side factors are word, POS tag, and Brown cluster (2000 classes). Target side factors are word, POS tag, Brown cluster (2000 classes), and morphological tag. UEDIN-A was trained with all corpora, whereas for UEDIN-B the parallel training data was restricted to the in-domain WIT$^3$ corpus. 
%
Additional features of the systems are:
\begin{packed_itemize}
\item A 5-gram LM over Brown clusters
\item LMs over morphological tags \\(UEDIN-A: 7-gram trained on all data, \\UEDIN-B: 7-gram trained on WIT$^3$)
\item A 7-gram LM over POS tags (UEDIN-A)
\end{packed_itemize}

\noindent Model weights of UEDIN-B were optimized on dev2010, model weights of UEDIN-A on a concatenation of dev2010 and dev2012.
