...
\subsection{Spoken Language Translation (SLT)}
\label{sec:slt}
...
%
Word alignments were created by aligning the data in both directions with
\MGIZA~\cite{Gao:2008:MGIZA} and symmetrizing the two trained
alignments~\cite{och03:alignmentComparison,koehn03:spb}.
%
The SRILM toolkit~\cite{stolcke02:srilm} was employed to create 5-gram language models
...
%
Phrase translation probabilities were smoothed with Good-Turing discounting.
%
...
A concatenation of dev2010 and dev2012 was utilized as development set.

Standard features of the German$\to$English MT system include:
\begin{packed_itemize}
\item Phrase translation and lexical translation scores
\item Word penalty and phrase penalty
...
UEDIN moreover incorporated several advanced features, in particular:
\begin{packed_itemize}
...
\noindent \textit{Phrase-based system.}
