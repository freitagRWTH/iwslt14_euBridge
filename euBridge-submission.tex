...
Pre-reordering \cite{collins-koehn-kucerova:2005:ACL} and compound splitting \cite{ref:koehn2003a} have been applied to the German source language side in a preprocessing step. 
The system was tuned on a concatenation of the dev2010 and dev2012 development sets.
