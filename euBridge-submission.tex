...
and capitalisation stripped, and the ``target language'' was the standard German parallel text.
...
Weights for the log-linear model combination have been tuned on a concatenation
of the dev2010 and dev2012 sets.
