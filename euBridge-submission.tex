...
(Section~\ref{combination}). Experimental results in are given in
...
The system combination of all 5 individual systems yield improvement of up tp 0.6 points in \BLEU compared to the best RWTH individual system output.
Using a recurrent neural network language model to rescore a 1000-best list of the system combination output, leads to slightly translation
improvement of 0.1 in \BLEU.
...
are given in \ref{tab:EnDeResults}. All system combination parameters are tuned on tst2012. The EU-Bridge submission enhanced the translation quality by
