...
Spoken Language Translation (SLT) translation track as well as to the German$\to$English,
English$\to$German and English$\to$French pure machine translation track.
%
...
presented in \cite{freitag14:jane,matusov:2006:eacl}, we applied a RNN network
...
In addition, for the language pairs involving German we apply the different reorderings of both language pairs using a lexicalized reordering model\cite{ref:koehn2005}.
