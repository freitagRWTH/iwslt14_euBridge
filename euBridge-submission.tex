...
%
One of the of the collaborative efforts within EU-BRIDGE is to produce
...
Aachen University which combinded the individual systems. The consensus
...
combination~\cite{freitag14:jane,matusov:2006:eacl}. Similar cooperative approaches based on
system combination have proven to be valuable for machine translation in previous
joint submissions, e.g.~\cite{freitag14:wmtEuBridge,freitag2013:euBridge}.
...
joint EU-BRIDGE submission to the IWSLT 2014 MT track.
  ...
  \begin{center}
    \begin{tabular}{l|c|c|c|c|c|c}
      ...
      & \BLEU & \TER & \BLEU & \TER & \BLEU & \TER \\
       ...
       \textbf{syscomRNN}                            & \rdm{35.2208} & \rdm{48.5278} & \rdm{41.7089} & \rdm{41.2702} & \rdm{44.3163} & \rdm{38.5443}
      \end{tabular}
     \end{center}
