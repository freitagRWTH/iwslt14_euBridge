...
We first address the generation of a confusion network from $I$ input translations. 
...
For the German$\to$English SLT translation task, we combined 3 different individual systems
generated by UEDIN, KIT and RWTH. Experimental results are given in Table~\ref{tab:DeEnSLTResults}.
The final system combination yield improvement of 1.5 points in \BLEU
and 1.2 points in \TER compared to the best single system generated by KIT. All single systems as
...
\begin{table}[bt!]
\caption{Results for the German$\to$English SLT translation task.}
...
Similar to the SLT track, the German$\to$English MT system combination submission is a combined translation of 3 different individual systems
generated by UEDIN, KIT and RWTH. Experimental results are given in Table~\ref{tab:DeEnResults}. The system combination parameters haven been optimized on test2012. 
Compared to the best individual system generated by RWTH, the system combination improved translation scores with up to 1.5 points in \BLEU and
1.1 points in \TER.

\begin{table}[bt!]
\caption{Results for the German$\to$English translation task.}
%Bold font indicates system combination results that are significantly better than the best single system (p $<$ 0.05).}
  %\vspace*{1.4em}
  \begin{center}
...
For the English$\to$French MT translation task, we combined 5 different individual systems. FBK, KIT and RWTH provided one individual system output
...
\begin{table}[bt!]
\caption{Results for the English$\to$French translation task.}
%Bold font indicates system combination results that are significantly better than the best single system (p $<$ 0.05).}
  %\vspace*{1.4em}
  \begin{center}
...
\begin{table}[bt!]
\caption{Results for the English$\to$German translation task.}
%Bold font indicates system combination results that are significantly better than the best single system (p $<$ 0.05).}
  %\vspace*{1.4em}
  \begin{center}
    \resizebox{0.98\textwidth}{!}{\begin{minipage}{\textwidth}
