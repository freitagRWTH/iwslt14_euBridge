...
\cite{ref:koehn2003a} have been applied to the German source language side in a
preprocessing step.  A factored translation model \cite{koehn2012factor} has
been employed. Source side factors are word, lemma, part-of-speech tag, and
