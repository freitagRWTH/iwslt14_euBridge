...
Data selection was performed by means of XenC toolkit \cite{Rousseau:2013:pbml} exploiting the bilingual cross-entropy difference \cite{axelrod-he-gao:2011:EMNLP} mode, separately for each available training corpus except the in-domain WIT$^3$ data.
%
