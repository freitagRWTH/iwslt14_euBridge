...
%
Different amount of texts were selected from each corpus ranging from 2\% to 30\%, and then concatenating for building one parallel corpus containing 57M English and 63M French running words in total.
...
The back-off table combination is similar to the fill-up technique  \cite{Bisazza:11b}, but does not add any provenance binary features.
